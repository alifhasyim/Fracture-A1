...
\begin{itemize}
    ...
    $h = b(0.4 + 0.04d_2) = 2.4(0.4 + 0.04 \times 6) = 2.4(0.4 + 0.24) = 2.4 \times 0.64 = 1.536 \text{ mm}$
    \item Crack length l
    
    $l = b(0.05 + 0.02d_3) = 2.4(0.05 + 0.02 \times 8) = 2.4(0.05 + 0.16) = 2.4 \times 0.21 = 0.504 \text{ mm}$
    \item Applied displacement u 
    
    $u = 0.001 + \frac{d_3}{1000} [\text{mm}] = 0.001 + \frac{8}{1000} = 0.001 + 0.008 = 0.009 \text{ mm}$  
...
\begin{itemize}
    \item Applied displacement u
    $u = 0.1 + \frac{d_3}{100}[\text{mm}] = 0.1 + \frac{8}{100} = 0.1 + 0.08 = 0.18 \text{ mm}$ 
\end{itemize}
\vspace{1em}


\section{Introduction} 
In this first assignments, the main focus will be on performing crack analysis
...
The second task is to analyze crack propagation using the cohesive zone method. Hence, some
cohesive elements will be defined along the pre-defined crack path with the 
cohesive parameters. From this analysis, a traction-separation curve will be obtained
to visualize the stress-displacement phenomenon of the seperation events. 
